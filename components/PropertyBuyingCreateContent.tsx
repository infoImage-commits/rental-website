...
import { useCreatePropertyBuying } from "@/lib/hooks/usePropertyBuying";
...
const defaultPayload: PropertyBuyingRequest = {
  ...
  price: 100000,
  currency: "USD",
  propertyTypeId: PropertyType.Apartment,
  status: PropertyBuyingStatus.Available,
  bedrooms: 1,
  bathrooms: 1,
  floors: 1,
  garage: 0,
...
export default function PropertyBuyingCreateContent() {
  ...
  const { mutate: createProperty, isPending } = useCreatePropertyBuying();
    ...
    <div className="mx-auto max-w-4xl min-w-0">
      <header className="mb-8">
        ...
        <h1 className="text-[26px] font-semibold leading-tight text-[#183c2f] lg:text-[32px]">
          Add New Buy Property
        </h1>
        <p className="mt-1 text-[14px] text-[#667c74]">
          Step {step} of 3 — Fill out the details below to create a new buying property listing.
        </p>
      </header>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
              <div>
                ...
                <select value={formData.propertyTypeId} onChange={e => updateForm({ propertyTypeId: Number(e.target.value) })} className="w-full rounded-xl border border-[#dfe8e4] px-4 py-2.5 text-[14px] outline-none focus:border-[#2e6f57] focus:ring-1 focus:ring-[#2e6f57]">
              ...
              <div>
                ...
                <input type="number" min={0} required value={formData.price} onChange={e => updateForm({ price: Number(e.target.value) })} className="w-full rounded-xl border border-[#dfe8e4] px-4 py-2.5 text-[14px] outline-none focus:border-[#2e6f57] focus:ring-1 focus:ring-[#2e6f57]" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-5">
              <div>
                ...
                <input type="number" min={0} value={formData.bedrooms} onChange={e => updateForm({ bedrooms: Number(e.target.value) })} className="w-full rounded-xl border border-[#dfe8e4] px-4 py-2.5 text-[14px] outline-none focus:border-[#2e6f57] focus:ring-1 focus:ring-[#2e6f57]" />
              </div>
              <div>
                <label className="mb-1.5 block text-[13px] font-medium text-[#183c2f]">Bathrooms</label>
                <input type="number" min={0} value={formData.bathrooms} onChange={e => updateForm({ bathrooms: Number(e.target.value) })} className="w-full rounded-xl border border-[#dfe8e4] px-4 py-2.5 text-[14px] outline-none focus:border-[#2e6f57] focus:ring-1 focus:ring-[#2e6f57]" />
              </div>
              <div>
                <label className="mb-1.5 block text-[13px] font-medium text-[#183c2f]">Floors</label>
                <input type="number" min={0} value={formData.floors} onChange={e => updateForm({ floors: Number(e.target.value) })} className="w-full rounded-xl border border-[#dfe8e4] px-4 py-2.5 text-[14px] outline-none focus:border-[#2e6f57] focus:ring-1 focus:ring-[#2e6f57]" />
              </div>
              <div>
                <label className="mb-1.5 block text-[13px] font-medium text-[#183c2f]">Garage</label>
                <input type="number" min={0} value={formData.garage} onChange={e => updateForm({ garage: Number(e.target.value) })} className="w-full rounded-xl border border-[#dfe8e4] px-4 py-2.5 text-[14px] outline-none focus:border-[#2e6f57] focus:ring-1 focus:ring-[#2e6f57]" />
              </div>
              <div>
                <label className="mb-1.5 block text-[13px] font-medium text-[#183c2f]">Area (m²)</label>
                <input type="number" min={1} value={formData.area} onChange={e => updateForm({ area: Number(e.target.value) })} className="w-full rounded-xl border border-[#dfe8e4] px-4 py-2.5 text-[14px] outline-none focus:border-[#2e6f57] focus:ring-1 focus:ring-[#2e6f57]" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
              <div>
                ...
                <input type="number" min={1800} value={formData.yearBuilt} onChange={e => updateForm({ yearBuilt: Number(e.target.value) })} className="w-full rounded-xl border border-[#dfe8e4] px-4 py-2.5 text-[14px] outline-none focus:border-[#2e6f57] focus:ring-1 focus:ring-[#2e6f57]" />
              </div>
              <div>
                <label className="mb-1.5 block text-[13px] font-medium text-[#183c2f]">Video URL</label>
                <input type="text" value={formData.videoUrl} onChange={e => updateForm({ videoUrl: e.target.value })} className="w-full rounded-xl border border-[#dfe8e4] px-4 py-2.5 text-[14px] outline-none focus:border-[#2e6f57] focus:ring-1 focus:ring-[#2e6f57]" />
              </div>
              <div>
                <label className="mb-1.5 block text-[13px] font-medium text-[#183c2f]">Virtual Tour URL</label>
                <input type="text" value={formData.virtualTourUrl} onChange={e => updateForm({ virtualTourUrl: e.target.value })} className="w-full rounded-xl border border-[#dfe8e4] px-4 py-2.5 text-[14px] outline-none focus:border-[#2e6f57] focus:ring-1 focus:ring-[#2e6f57]" />
              </div>
            </div>
          </div>
        )}
